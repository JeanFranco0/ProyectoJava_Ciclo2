...
public class Carrito extends JFrame implements ActionListener{
	...
	void productos3() {
		c= ac.obtener(17);
		imprimir("\n------------------------------------------------------------------------------------------------------------------------------------------------------------");
		imprimir("  "+c.getIdPr() + "\t " + c.getNombrePr() + "\t\t  S/. " + c.getPrecioPr() + ".00\t   " + (c.getCantPr()-(c.getCantPr()-pro3.cantPr9)) + "\t" + pro3.totalpr9);
			
		c= ac.obtener(1);
		imprimir("\n");
		imprimir("  "+c.getIdPr() + "\t " + c.getNombrePr() + "\t\t  S/. " + c.getPrecioPr() + ".00\t   " + (c.getCantPr()-(c.getCantPr()-pro3.cantPr10)) + "\t" + pro3.totalpr10);
		
		c= ac.obtener(14);
		imprimir("\n");
		imprimir("  "+c.getIdPr() + "\t " + c.getNombrePr() + "\t\t  S/. " + c.getPrecioPr() + ".00\t   " + (c.getCantPr()-(c.getCantPr()-pro3.cantPr11)) + "\t" + pro3.totalpr11);
		
		c= ac.obtener(6);
		imprimir("\n");
		imprimir("  "+c.getIdPr() + "\t " + c.getNombrePr() + "\t\t  S/. " + c.getPrecioPr() + ".00\t   " + (c.getCantPr()-(c.getCantPr()-pro3.cantPr12)) + "\t" + pro3.totalpr12);
	}
