...
import GuisPrincipal.Configuracion;
import GuisPrincipal.Descuento;
...
public class inicio extends JFrame implements ActionListener{
	...
	void GUI(){
		...
		JMPrecios.addActionListener(this);
		...
		JMDescuentos.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == JMPrecios) {
			actionEventPerformedJMPrecios(e);
		}
		if(e.getSource() == JMDescuentos) {
			actionEventPerformedJMDescuentos(e);
		}
	...
	protected void actionEventPerformedJMPrecios(ActionEvent arg0) {
		Configuracion config = new Configuracion();
		config.setVisible(true);
	}
	protected void actionEventPerformedJMDescuentos(ActionEvent arg0) {
