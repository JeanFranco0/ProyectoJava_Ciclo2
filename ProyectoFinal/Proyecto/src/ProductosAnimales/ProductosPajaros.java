...
public class ProductosPajaros extends JFrame implements ActionListener{
	...
	protected void actionEventPerformedbtnA1(ActionEvent arg0){
		if(txtColgantesPajaros.getText().matches("[0-9]{1,3}")) {
			c = ac.obtener(24);
			cantPr1 = Integer.parseInt(txtColgantesPajaros.getText().trim());
			if(cantPr1 < c.getCantPr()){
				valorpr1 = true;
				if(valorpr1 == true) {
					totalprPajaro1 = c.getPrecioPr() * cantPr1;
				...
				error("No hay tantos productos en stock", txtColgantesPajaros);
			}
			if(valorpr1 == false) {
				totalprPajaro1 = 0;
			}
			...
			error("Ingresa la cantidad correctamente", txtColgantesPajaros);
		}
		
	}
	protected void actionEventPerformedbtnA2(ActionEvent arg0) {
		if(txtColumpiosPajaros.getText().matches("[0-9]{1,3}")) {
			c = ac.obtener(25);
			cantPr2 = Integer.parseInt(txtColumpiosPajaros.getText().trim());
			if(cantPr2 < c.getCantPr()){
				valorpr2 = true;
				if(valorpr2 == true) {
					totalprPajaro2 = c.getPrecioPr() * cantPr2;
				...
				error("No hay tantos productos en stock", txtColumpiosPajaros);
			}
			if(valorpr2 == false) {
				totalprPajaro2 = 0;
			}
			...
			error("Ingresa la cantidad correctamente", txtColumpiosPajaros);
		}
		
	}
	protected void actionEventPerformedbtnA3(ActionEvent arg0) {
		if(txtEscalerasPajaros.getText().matches("[0-9]{1,3}")) {
			c = ac.obtener(26);
			cantPr3 = Integer.parseInt(txtEscalerasPajaros.getText().trim());
			if(cantPr3 < c.getCantPr()){
				valorpr3 = true;
				if(valorpr3 == true) {
					totalprPajaro3 = c.getPrecioPr() * cantPr3;
				...
				error("No hay tantos productos en stock", txtEscalerasPajaros);
			}
			if(valorpr3 == false) {
				totalprPajaro3 = 0;
			}
			...
			error("Ingresa la cantidad correctamentes", txtEscalerasPajaros);
		}
	}
	protected void actionEventPerformedbtnA4(ActionEvent arg0) {
		if(txtHamacasPajaros.getText().matches("[0-9]{1,3}")) {
			c = ac.obtener(27);
			cantPr4 = Integer.parseInt(txtHamacasPajaros.getText().trim());
			if(cantPr4 < c.getCantPr()){
				valorpr4 = true;
				if(valorpr4 == true) {
					totalprPajaro4 = c.getPrecioPr() * cantPr4;
				...
				error("No hay tantos productos en stock", txtHamacasPajaros);
			}
			if(valorpr4 == false) {
				totalprPajaro4= 0;
			}
			...
			error("Ingresa la cantidad correctamentes", txtHamacasPajaros);
		}
	}
	void precio() {
